<div class="easyazon-popup-state" data-bind="visible: searchActive, with: search">
	<h3><?php _e('Search Options', 'easyazon'); ?></h3>
	...
	<form action="admin-ajax.php" id="easyazon-popup-form" method="post">
		<table class="form-table">
			<tbody>
				...
				<tr>
					<th scope="row"><label for="easyazon-search-keywords"><?php _e('Search Keywords or ASIN', 'easyazon'); ?></label></th>
					<td>
				...
				<tr>
					...
					<td>
						<select id="easyazon-search-locale" data-bind="value: locale">
							<?php foreach($locales as $locale => $locale_name) { ?>
		...
		<p>
			...
			<button class="button button-primary button-large" id="easyazon-search-submit" data-bind="click: initiate"><?php _e('Search', 'easyazon'); ?></button>
	...
	<div class="easyazon-search-results" data-bind="visible: searchDone">
		...
		<div class="tablenav top">
			<div class="tablenav-pages">
				<span class="displaying-num"><span data-bind="text: resultsNumber"></span> <?php _e('products', 'easyazon'); ?></span>
				<span class="pagination-links">
					<a class="prev-page button" title="<?php _e('Go to the previous page', 'easyazon'); ?>" href="#" data-bind="click: pagePrev, css: { disabled: pagePrevEmpty }">&lsaquo;</a>
					<span class="paging-input">
						<span data-bind="text: page"></span> <?php _e('of', 'easyazon'); ?> <span class="total-pages" data-bind="text: pages"></span>
					</span>
					<a class="next-page button" title="<?php _e('Go to the next page', 'easyazon'); ?>" href="#" data-bind="click: pageNext, css: { disabled: pageNextEmpty }">&rsaquo;</a>
				</span>
			</div>
		</div>
		...
		<table class="widefat fixed">
			...
			<tbody>
				<tr data-bind="visible: resultsEmpty">
					<td colspan="<?php echo count($search_result_columns); ?>"><?php _e('No products were found', 'easyazon'); ?></td>
				</tr>
