...
class EasyAzon_Components_About {
	...
	public static function add_about_page($parent) {
		$page = add_submenu_page($parent, __('EasyAzon - Free Amazon Course', 'easyazon'), __('Free Amazon Course', 'easyazon'), 'manage_options', EASYAZON_ABOUT_PAGE, array(__CLASS__, 'display_about_page'));
