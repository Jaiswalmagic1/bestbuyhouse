...
class EasyAzon_Components_Settings {
	...
	public static function add_admin_pages() {
		$easyazon = add_menu_page(__('EasyAzon', 'easyazon'), __('EasyAzon', 'easyazon'), 'manage_options', EASYAZON_SETTINGS_PAGE, array(__CLASS__, 'display_settings_page'), EASYAZON_SETTINGS_ICON, 10001);

		do_action('easyazon_add_admin_pages', EASYAZON_SETTINGS_PAGE);
	}

	public static function add_settings_page($parent) {
		$page = add_submenu_page($parent, __('EasyAzon - Settings', 'easyazon'), __('Settings', 'easyazon'), 'manage_options', $parent, array(__CLASS__, 'display_settings_page'));
