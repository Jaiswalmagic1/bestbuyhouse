...
class EasyAzon_Components_SettingsSections_Search {
	...
	public static function add_settings_section_and_fields($page) {
		add_settings_section(EASYAZON_SETTINGS_SECTION_SEARCH, __('Search', 'easyazon'), array(__CLASS__, 'display_settings_section'), $page);

		add_settings_field('default_search_locale', __('Default Search Locale', 'easyazon'), array(__CLASS__, 'display_settings_field_default_search_locale'), $page, EASYAZON_SETTINGS_SECTION_SEARCH, array(
