...
class EasyAzon_Components_SettingsSections_Upgrade {
	...
	public static function add_settings_section_and_fields($page) {
		add_settings_section(EASYAZON_SETTINGS_SECTION_UPGRADE, __('How to Earn More from Amazon', 'easyazon'), array(__CLASS__, 'display_settings_section'), $page);
	}
	...
	public static function load_settings_page() {
		...
		wp_localize_script('easyazon-settings-upgrade', 'EasyAzon_Settings_Upgrade', array(
			'day'    => __('day', 'easyazon'),
			'days'   => __('days', 'easyazon'),
			'month'  => __('month', 'easyazon'),
			'months' => __('months', 'easyazon'),
		));
	}
