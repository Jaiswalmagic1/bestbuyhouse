...
function easyazon_get_sort_values() {
	...
	if(is_null($sorts)) {
		$sorts = array(
			array(
				'key'  => false,
				'name' => __('Default', 'easyazon'),
			),
			array(
				'key'  => 'AvgCustomerReviews',
				'name' => __('Average Customer Reviews', 'easyazon'),
			),
			array(
				'key'  => 'Featured',
				'name' => __('Featured Items', 'easyazon'),
			),
			array(
				'key'  => 'NewestArrivals',
				'name' => __('Newest Arrivals', 'easyazon'),
			),
			array(
				'key'  => 'Price:HighToLow',
				'name' => __('Price: High to Low', 'easyazon'),
			),
			array(
				'key'  => 'Price:LowToHigh',
				'name' => __('Price: Low to High', 'easyazon'),
			),
			array(
				'key'  => 'Relevance',
				'name' => __('Relevance', 'easyazon'),
			),
		);
	}
