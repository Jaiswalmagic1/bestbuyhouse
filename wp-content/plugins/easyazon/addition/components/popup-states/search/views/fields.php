<tr data-bind="visible: indicesExist">
	<th scope="row"><label for="easyazon-search-search-index"><?php _e('Search Index', 'easyazon'); ?></label></th>
	<td>
...
<tr data-bind="visible: priceMinAvailable">
	<th scope="row"><label for="easyazon-search-minimum-price"><?php _e('Minimum Price', 'easyazon'); ?></label></th>
	<td>
		<input type="text" class="code regular-text" id="easyazon-search-minimum-price" data-bind="value: priceMin" />
		<p class="description"><?php _e('This value will be interpreted in the context of the locale you are searching within (e.g. $ in the United States)', 'easyazon'); ?></p>
	</td>
</tr>

<tr data-bind="visible: priceMaxAvailable">
	<th scope="row"><label for="easyazon-search-maximum-price"><?php _e('Maximum Price', 'easyazon'); ?></label></th>
	<td>
...
<tr data-bind="visible: sortsExist">
	<th scope="row"><label for="easyazon-search-search-index"><?php _e('Sort', 'easyazon'); ?></label></th>
	<td>
