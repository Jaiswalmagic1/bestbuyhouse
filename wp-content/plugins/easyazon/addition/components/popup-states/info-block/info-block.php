...
class EasyAzon_Addition_Components_PopupStates_InfoBlock {
	...
	public static function add_insert_links($links) {
		$links[] = sprintf('<a href="#" data-bind="click: $root.infoBlockActivate">%s</a>', esc_html(__('Info Block', 'easyazon')));
	...
	public static function enqueue_scripts() {
		wp_enqueue_script('easyazon-addition-popup-states-infoblock', plugins_url('resources/popup-state.js', __FILE__), array('easyazon-popup'), EASYAZON_VERSION, true);

		wp_localize_script('easyazon-addition-popup-states-infoblock', 'EasyAzon_Addition_PopupStates_InfoBlock', array(
			'shortcode' => EASYAZON_ADDITION_SHORTCODE_INFO_BLOCK,
		));
	}
...
EasyAzon_Addition_Components_PopupStates_InfoBlock::init();
