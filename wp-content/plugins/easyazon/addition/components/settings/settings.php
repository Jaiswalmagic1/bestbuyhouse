...
class EasyAzon_Addition_Components_Settings {
	...
	public static function link_to_free_course() {
		printf(__('<div class="notice notice-info"><p><strong>Do you want to make the most of EasyAzon? Take our <a href="%s" target="_blank">free Amazon course</a> to increase your site\'s earnings today!</strong></p></div>'), 'https://easyazon.com/amazon-affiliate-course/');
	}

	#endregion Administrative Interface
}

EasyAzon_Addition_Components_Settings::init();
